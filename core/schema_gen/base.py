"""
Abstract Base Class for Schema Generation.

This module defines the abstract interface that all schema generation
...
class SchemaGenerator(ABC):
    """
    Abstract base class for schema generation from unstructured documents.
    
    This class defines the interface and common utilities for schema generation.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        """
        self.config = config
        self.loader = None  # Data loader will be set by subclasses
    
    @abstractmethod
    def __call__(self, dataset_task_list: Optional[list] = None):
        """
    ...
    def __str__(self) -> str:
        ...
        Returns:
            String describing the schema generator
        """
